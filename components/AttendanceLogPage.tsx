                    ...
                    <div className="space-y-6">
                         <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg">
                            ...
                            <div className="flex items-center space-x-4">
                                <img src={userToVerify?.imageUrl || null} alt={userToVerify?.name} className="h-16 w-16 rounded-full object-cover ring-2 ring-primary-500 ring-offset-2 dark:ring-offset-slate-800" />
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-2xl animate-fade-in-down">
            ...
            <div className="mt-6">
                <div className="group flex items-center w-full bg-slate-200/20 dark:bg-slate-900/30 border border-slate-400 dark:border-slate-600 rounded-lg p-3 text-xl font-mono tracking-wider focus-within:border-primary-500 transition-all">
                    ...
                    <span className="mx-[5px] text-slate-400">/</span>
                    ...
                    <span className="mx-[5px] text-slate-400">/</span>
                    <input value={pinParts.roll} onChange={e => handlePinChange(e.target.value)} placeholder="001" maxLength={3} className="w-[49px] bg-transparent outline-none text-slate-800 dark:text-white" />
                </div>
            </div>
            ...
            <div className="mt-8 min-h-[3rem]">
                {userToVerify && !referenceImageError && (
                    <div className="flex items-center justify-center gap-4 animate-fade-in bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                        <img src={userToVerify.imageUrl || null} className="w-12 h-12 rounded-full object-cover" alt="" />
                        ...
                        cameraStatus !== 'failed' ? (
                            capturedImage ? (
                                <div className="flex items-center gap-4 animate-fade-in">
                                    <img src={capturedImage || null} alt="Captured" className="w-40 h-40 rounded-full object-cover shadow-lg border-2 border-primary-500" />
                                    <Icons.send className="w-8 h-8 text-slate-400" />
                                    <img src={userToVerify?.referenceImageUrl || userToVerify?.imageUrl || null} alt="Reference" className="w-40 h-40 rounded-full object-cover shadow-lg border-2 border-slate-500" />
                                </div>
                            ) : (
